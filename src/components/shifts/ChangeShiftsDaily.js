...
class ChangeShiftsDaily extends Component{
    constructor(){
        super();
        this.state={
            shiftOne:true,
    ...
    render(){
        ...
        return(
            <div>             
                <div style={{textAlign:'left', paddingBottom:'35px'}}>
                    
                {shiftOne && <DatePickers />}
               
                {shiftTwo && <DatePickers/>}
                {shiftThree && <DatePickers/>}
...
export default ChangeShiftsDaily;